...
export default async function DashboardPage() {
  // Supabase server client with cookie helpers
    ...
    >
      ...
      >
        <div>
          ...
          {/* build marker to verify deploys */}
          <p style={{ color: '#888', margin: 0 }}>build: v8</p>
      ...
      <section style={{ marginTop: 24 }}>
        ...
        >
          ...
          <a href="/teams/new" style={{ fontWeight: 600, textDecoration: 'none' }}>
            + New Team
          </a>
        </div>
        {teams.length === 0 ? (
            ...
            {teams.map((t) => (
              ...
              >
                ...
                >
                  ...
                  <a href={`/teams/${t.id}`} style={{ textDecoration: 'none' }}>
                    Open →
                  </a>
                </div>
              </li>
      ...
      <section style={{ marginTop: 36 }}>
        ...
        >
          ...
          <a href="/sites/new" style={{ fontWeight: 600, textDecoration: 'none' }}>
            + New Site
          </a>
        </div>
        {sites.length === 0 ? (
